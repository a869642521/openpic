...
Tip: Keep when archiving or proving copyright; remove for web, dev, or anonymous submissions to protect privacy and reduce file size.`,
  ...
  'page.compression.watch.card.filter_enabled_tip': 'Enabled, files smaller than threshold will be ignored',
  'page.compression.watch.card.filter_disabled_tip': 'Click to enable, ignore files smaller than specified size',
  'page.compression.watch.card.remove': 'Remove Monitor',
  'page.compression.watch.card.open_folder_tip': 'Click to open folder',
  'page.compression.watch.list.title': 'Processed Files',
  'page.compression.watch.list.processed': 'Processed: {{count}}',
  'page.compression.watch.list.existing': 'Existing: {{count}}',
  'page.compression.watch.list.section_existing': 'Existing (not compressed)',
  'page.compression.watch.status.pending': 'Not compressed',
  'page.compression.watch.list.empty_title': 'Waiting for new images',
  'page.compression.watch.list.empty_description':
    'New images added, copied or moved to the watched folder will appear here and be compressed automatically',
