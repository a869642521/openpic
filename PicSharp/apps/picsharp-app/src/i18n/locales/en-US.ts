...
Tip: Keep when archiving or proving copyright; remove for web, dev, or anonymous submissions to protect privacy and reduce file size.`,
  ...
  'page.compression.watch.guide.add_mode_dialog_title': 'Select Watch Mode',
  'page.compression.watch.guide.add_mode_dialog_description': 'When adding a folder for the first time, choose how to watch',
  'page.compression.watch.guide.add_mode_monitor_only': 'Monitor New Only',
  'page.compression.watch.guide.add_mode_monitor_only_desc': 'Only watch for new images, skip existing files',
  'page.compression.watch.guide.add_mode_compress_then_monitor': 'Compress Existing First',
  'page.compression.watch.guide.add_mode_compress_then_monitor_desc': 'Compress all existing images (including subfolders) first, then watch for new ones',
  ...
  'page.compression.watch.folder.settings_title': 'Folder Compression Settings',
