export default {
  ...
  'page.compression.watch.guide.add_mode_dialog_title': '选择监听模式',
  'page.compression.watch.guide.add_mode_dialog_description': '首次添加文件夹时，请选择监听方式',
  'page.compression.watch.guide.add_mode_monitor_only': '仅监控新图',
  'page.compression.watch.guide.add_mode_monitor_only_desc': '只监听后续新增的图片，目录内已有图片不压缩',
  'page.compression.watch.guide.add_mode_compress_then_monitor': '先压缩存量图再监控',
  'page.compression.watch.guide.add_mode_compress_then_monitor_desc': '先压缩目录内所有图片（含子文件夹），完成后继续监听新图',
  ...
  'page.compression.watch.folder.settings_title': '文件夹压缩设置',
