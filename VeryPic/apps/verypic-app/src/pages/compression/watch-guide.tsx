...
/** 监听引导页「添加文件夹」：实心黑、固定宽度不撑满父级（与工作区列表全宽灰框按钮区分） */
const WATCH_GUIDE_ADD_FOLDER_BUTTON_CLASS =
  'h-12 w-[220px] max-w-[220px] shrink-0 flex-none cursor-pointer gap-2 rounded-full border-0 bg-black text-base text-white shadow-none hover:bg-neutral-800 dark:bg-black dark:text-white dark:hover:bg-neutral-800';
        ...
        {isValidArray(history) ? (
          <>
            <div className='mb-4 flex w-full items-center justify-between'>
              ...
              <Button
                variant='default'
                className={WATCH_GUIDE_ADD_FOLDER_BUTTON_CLASS}
                onClick={() => handleWatch()}
              >
                <Plus size={18} />
          ...
          <>
            ...
            <Button
              variant='default'
              className={cn('mt-6', WATCH_GUIDE_ADD_FOLDER_BUTTON_CLASS)}
              onClick={() => handleWatch()}
            >
              <Plus size={18} />
              {t('page.compression.watch.guide.add_folder')}
