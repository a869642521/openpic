...
import { CompressionMode, CompressionOutputMode, ConvertFormat, TinypngMetadata, ResizeMode, ResizeFit } from '@/constants';
        ...
        <Tabs
          ...
          onValueChange={(v) => {
            ...
            updateClassicSettings({
              ...
              // 切回 auto 时关闭目标大小，避免 skipBelowBytes 仍生效而过滤图片
              ...(!isFilter ? { targetSizeEnable: false } : {}),
            ...
            if (isFilter) {
              ...
              // 切回 auto 后重置访问标记，下次进入 filter 时重新自动开启目标大小
              filterTabVisitedRef.current = false;
            }
          }}
        >
          <CardHeader
            ...
            <TabsContent value='auto' className='m-0 space-y-4'>
              <div className='flex items-center justify-between gap-3'>
                ...
                <Select
                  ...
                  onValueChange={(v) => {
                    updateClassicSettings({ compressionMode: v as CompressionMode });
                  }}
                >
